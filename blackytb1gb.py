...
def main():
    ...
    st.markdown(
        ...
        .css-1d391kg, .css-1cpxqw2 {  /* blok container */
    ...
    if show_ads:
        ...
        components.html(
            """
            <div style="background:#161b22;padding:20px;border-radius:10px;text-align:center;color:white;">
                <script type='text/javascript' 
                        src='//pl26562103.profitableratecpm.com/28/f9/95/28f9954a1d5bbf4924abe123c76a68d2.js'>
                </script>
                <p style="color:#bbb">Iklan akan muncul di sini</p>
            </div>
            """,
            height=300
        )
